 ...
 */
final class Version20250417144704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, langage VARCHAR(255) NOT NULL, thumbnail_url LONGTEXT NOT NULL, publication_date DATETIME DEFAULT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE publisher (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, amount NUMERIC(5, 2) NOT NULL, created_at DATETIME NOT NULL, user_id INT DEFAULT NULL, INDEX IDX_723705D1A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE transaction_subscription (transaction_id INT NOT NULL, subscription_id INT NOT NULL, INDEX IDX_E6A5B1B32FC0CB0F (transaction_id), INDEX IDX_E6A5B1B39A1887DC (subscription_id), PRIMARY KEY(transaction_id, subscription_id)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE transaction_subscription ADD CONSTRAINT FK_E6A5B1B32FC0CB0F FOREIGN KEY (transaction_id) REFERENCES transaction (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE transaction_subscription ADD CONSTRAINT FK_E6A5B1B39A1887DC FOREIGN KEY (subscription_id) REFERENCES subscription (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE transaction_subscription DROP FOREIGN KEY FK_E6A5B1B32FC0CB0F
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE transaction_subscription DROP FOREIGN KEY FK_E6A5B1B39A1887DC
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE transaction_subscription
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE user
        SQL);
